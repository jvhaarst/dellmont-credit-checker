...
while getopts ":dc:f:hlm:npqsu:vw" optname $@$OPTS; do
	case "$optname" in
...
License: Copyright © 2017 Dominic Raferd. Licensed under the Apache License, \
