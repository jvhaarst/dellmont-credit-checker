...
Mozilla/5.0 (Windows NT 6.1; WOW64; rv:22.0) Gecko/20100101 Firefox/22.0">/tmp/$THIS-useragents.txt
USERAGENT="$(sort -R /tmp/$THIS-useragents.txt|head -n 1)"; rm /tmp/$THIS-useragents.txt
